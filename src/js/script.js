...
const duplasDetalhes = {
    'itachi-kisame': {
        ...
        descricao: 'Itachi, mestre do genjutsu, e Kisame, o monstro da névoa, formam uma dupla de furtividade e força bruta. Suas missões são rápidas, limpas e quase impossíveis de rastrear. Juntos, equilibram inteligência estratégica e poder destrutivo.',
        curiosidades: [
    ...
    'hidan-kakuzu': {
        ...
        descricao: 'Hidan, o imortal sádico, e Kakuzu, o caçador de recompensas, unem brutalidade e ganância. Impossíveis de matar, são temidos até entre criminosos. Suas discussões são lendárias, mas funcionam perfeitamente em combate.',
        curiosidades: [
    ...
    'deidara-sasori': {
        ...
        descricao: 'Deidara, o artista das explosões, e Sasori, o mestre das marionetes, misturam criatividade e veneno em ataques imprevisíveis e devastadores. Suas filosofias sobre arte são opostas, mas juntos são imparáveis.',
        curiosidades: [
    ...
    'pain-konan': {
        ...
        descricao: 'Pain, o líder absoluto, e Konan, a anjo de papel, comandam a Akatsuki com estratégia, poder e lealdade inabalável. São os fundadores e o coração da organização.',
        curiosidades: [
...
document.getElementById('dupla-modal-close').addEventListener('click', function() {
